...
public class InquiryUpdate implements Controller {
	
	private static final Log log = LogFactory.getLog(InquiryUpdate.class);
	@Override
	public InquiryHandlerAdapter execute(HttpServletRequest request, HttpServletResponse response) {
		...
		inquiryHandlerAdapter.setPath("/WEB-INF/inquiry/inquiry_update.jsp");
