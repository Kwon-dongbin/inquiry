...
<div class="card-body">
<form action="./InquiryAnswer.in" method="post" id="sign_inquiry">
<fieldset>
<div class="ml-sm-3">
...
<div class="ml-sm-3">
<input type="text" name="inquiry_title" id="inquiry_title" class="form-control form-control-sm" value="${inquiryDTO.inquiry_title}" readonly>
</div>
</div>
<div class="form-group row">
    <label for="inquiry_content" class="ml-sm-3 col-form">문의 내용</label>
    <div class="ml-sm-3">
        <textarea name="inquiry_content" id="inquiry_content" class="form-control form-control-sm" rows="6" style="width: 500px;" readonly>${inquiryDTO.inquiry_content}</textarea>
    </div>
</div>
<div class="form-group row">
    <label for="inquiry_answer" class="ml-sm-3 col-form">답변</label>
    <div class="ml-sm-3">
        <textarea name="inquiry_answer" id="inquiry_answer" class="form-control form-control-sm" rows="6" style="width: 500px;">${inquiryDTO.inquiry_answer}</textarea>
    </div>
</div>
