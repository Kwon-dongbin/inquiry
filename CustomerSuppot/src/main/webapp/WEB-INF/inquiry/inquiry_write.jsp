...
<div class="card-body">
<form action="./InquiryWrite.in" method="post" id="sign_inquiry">
<fieldset>
<div class="form-group row">
<label for="inquiry_title" class="ml-sm-3 col-form-label"> 글 제목 </label>
<div class="ml-sm-3">
    <input type="text" name="inquiry_title" id="inquiry_title" class="form-control form-control-sm" onkeyup="checkInputLength()">
...
<div class="form-group row">
    ...
    <div class="ml-sm-3">
        <textarea name="inquiry_content" id="inquiry_content" class="form-control form-control-sm" rows="6" style="width: 500px;" onkeyup="checkInputLength()"></textarea>
